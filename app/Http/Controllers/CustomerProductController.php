...
class CustomerProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customer_product->certificate_img        = $request->certificate_img;

        $customer_product->unit   = $request->unit ?? '';
        $customer_product->width  = $request->width ?? '';
        $customer_product->height = $request->height ?? '';
        $customer_product->depth  = $request->depth ?? '';
        ...
        if($customer_product->save()){
            ...
            $customer_product_translation->width  = $request->width;
            $customer_product_translation->height = $request->height;
            $customer_product_translation->depth  = $request->depth;
