...
class ProductController extends Controller
{
    ...
    public function createProductNewSeller(Request $request)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('seller.product.products.create_productnewseller', compact('categories'));
    }
    public function store(ProductRequest $request)
    {
        ...
        ProductTranslation::create($request->only([
            'lang', 'name', 'unit', 'description', 'product_id','width','height', 'depth'
        ]));
