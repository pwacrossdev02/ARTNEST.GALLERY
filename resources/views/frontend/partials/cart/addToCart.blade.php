                        ...
                        <div class="col-9">
                            <div class="">
                                ...
                                @if($product->width != null)
                                    <span class="opacity-70 ml-1">{{ translate('Width') }}: {{ $product->getTranslation('width') }} cm</span>
                                @endif

                                @if($product->height != null)
                                    <span class="opacity-70 ml-1">{{ translate('Height') }}: {{ $product->getTranslation('height') }} cm</span>
                                @endif

                                @if($product->depth != null)
                                    <span class="opacity-70 ml-1">{{ translate('Depth') }}: {{ $product->getTranslation('depth') }} cm</span>
                                @endif
