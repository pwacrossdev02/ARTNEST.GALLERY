                                        ...
                                        <div class="">
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('shops.store') }}" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded-0{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" placeholder="{{  translate('Full Name') }}" name="name" required oninput="updateShopName(this.value)">
                                                    @if ($errors->has('name'))
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"   name="shop_name" id="shop_name" hidden>
                                          

                                                    <input type="text"  name="address" hidden value="-">
...
@section('script')
    ...
    function updateShopName(value) {
        document.getElementById('shop_name').value = value;
    }
</script>
@endsection