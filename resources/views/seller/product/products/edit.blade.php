    ...
    <div class="row gutters-5">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="brand">
                        <label class="col-lg-3 col-from-label">{{translate('Artists')}}</label>
                        <div class="col-lg-8">
                   ...
                   <!-- Dimensions Title -->
                    <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{ translate('Dimensions') }} 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{translate('Unit Price (in EUROS)')}}</label>
                        <div class="col-lg-6">
