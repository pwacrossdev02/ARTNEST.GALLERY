    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('sellerbrands.index') }}"
                    class="aiz-side-nav-link {{ areActiveRoutes(['sellerbrands.index', 'sellerbrands.create', 'sellerbrands.edit'])}}">
                        <i class="las la-palette aiz-side-nav-icon"></i>

                        <span class="aiz-side-nav-text">{{translate('All Artists')}}</span>
                    </a>
                </li>
