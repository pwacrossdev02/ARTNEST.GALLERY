                                ...
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row" id="brand">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Artists')}} <span class="text-danger">*</span></label>
                                            <div class="col-xxl-9">
                                                ...
                                                <small class="text-muted">{{translate("You can choose a Artists if you'd like to display your product by Artists.")}}</small>
                                            </div>
                                        </div>
                                        <!-- Unit -->
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <input type="number" class="form-control @error('width') is-invalid @enderror" 
                                                                name="width" placeholder="{{ translate('Width') }}" 
                                                                value="{{ $product->getTranslation('width', $lang) }}" required>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <input type="number" class="form-control @error('height') is-invalid @enderror" 
                                                                name="height" placeholder="{{ translate('Height') }}" 
                                                                value="{{ $product->getTranslation('height', $lang) }}" required>
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">cm</span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <input type="number" class="form-control @error('depth') is-invalid @enderror" 
                                                                name="depth" placeholder="{{ translate('Depth') }}" 
                                                                value="{{ $product->getTranslation('depth', $lang) }}" required>
                                                            <div class="input-group-append">
                                                                <span class="input-group-text">cm</span>
                                                            </div>
                                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            ...
                                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                            <input type="hidden" name="certificate_img" value="{{ $product->certificate_img ?? '' }}" class="selected-files" required>
                                        </div>
                                        <div class="file-preview box sm"></div>
                                        <small class="text-muted">
                                            {{ translate("Upload a valid Certificate of Authenticity for the product. Ensure the certificate is clear, legible, and accurate.") }}
                                        </small>
                                    </div>
                                </div>
                            </div>
