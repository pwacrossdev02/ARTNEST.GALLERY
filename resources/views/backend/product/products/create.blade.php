                            ...
                            <div class="w-100">
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-xxl-9">
                                                <input type="number" lang="en" class="form-control @error('min_qty') is-invalid @enderror" name="min_qty" value="{{ old('min_qty') ?? 1 }}" hidden placeholder="1" min="1" required>
                                    ...
                                    <div class="col-xxl-5 col-xl-6">
                                        <div class="card @if($errors->has('category_ids') || $errors->has('category_id')) border border-danger @endif">
                                            ...
                                            <div class="card-body">
                                                <div class="h-500px overflow-auto c-scrollbar-light">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                ...
                                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                <input type="hidden" name="certificate_img" class="selected-files" value="{{ $product->certificate_img ?? '' }}" required>
                                            </div>
