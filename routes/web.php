...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(ConversationMessagesController::class)->group(function () {
        ...
        Route::get('/conversations/fetch', [ConversationMessagesController::class, 'fetchMessages'])->name('conversations.fetch');
        Route::post('/conversations/send_message', [ConversationMessagesController::class, 'sendMessage'])->name('conversations.send_message');
